...
<head>
    ...
    <meta name="description" content="<?= env('title') ?> - Share messages easily & fastly.">
    ...
    <meta property="og:image:alt" content="<?= env('title') ?> - Share messages easily & fastly.">
    <meta property="og:description" content="<?= env('title') ?> - Share messages easily & fastly.">
    ...
    <meta name="twitter:description" content="<?= env('title') ?> - Share messages easily & fastly.">
    <meta name="twitter:image:alt" content="<?= env('title') ?> - Share messages easily & fastly.">
